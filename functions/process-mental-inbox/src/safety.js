/**
 * Independent Safety Engine (spec section 61) — runs BEFORE any other
 * processing of free-text user input. Deterministic and keyword-based by
 * design: a safety gate must be fast, auditable, and not depend on an LLM
 * being available or behaving predictably. This is a first-pass net, not
 * a clinical instrument — it is deliberately biased toward over-flagging
 ...
 * and never claims certainty. It only decides: does this input skip
 * normal processing and get the safety response instead?
 */
