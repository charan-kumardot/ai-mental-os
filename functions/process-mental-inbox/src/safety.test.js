...
// AI red-team (spec §102) — this classifier is deliberately regex-based,
// not an LLM call, specifically so it can't be talked out of flagging real
// risk language the way a prompt-injection attack could talk a model out
// of following its own system prompt. These tests exist to prove that
// architectural choice actually holds under an adversarial wrapper.
